...
public class RutaTurno {
	 ...
	 * @param nCiudadOrigen es la ciudad de origen de la ruta.
	 * @param nCiudadDestino la ciudad de destino de la ruta.
	 * @param nHoraSalida la hora de salida de la ruta.
	 */
