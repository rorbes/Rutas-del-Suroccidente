...
public class Propietario 
{
	 ...
	 * @param nIdentifacion La identificacion del propietario
	 * @param nNombres El nombre del propietario
	 * @param nApellidos El apellido del propietario
	 * @param nDireccion La direccion del propietario
	 * @param nTelefono El telefono del propietario.
	 */
